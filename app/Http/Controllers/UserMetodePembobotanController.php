...
class UserMetodePembobotanController extends Controller
{
    ...
    public function ahp_store(Request $request)
    {
        ...
        // Jika tidak ada kriteria, beri pesan error
        if ($kriterias->isEmpty()) {
            return redirect()->back()
                ->with('error', 'Tidak ada kriteria yang tersedia. Silakan buat kriteria terlebih dahulu.');
        }
        ...
        $bobot_tiap_kriteria = $kriterias->pluck('bobot')->toArray();
